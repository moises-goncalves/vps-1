...
list_top3 = dict(heapq.nlargest(3, prices.items(), key=lambda item: item[1]))
print(list_top3)


"""
迭代工具模块 返回一个迭代对象 直接打印输出地址 需要使用next()方法获取下一个元素 或者list转化为列表
"""
import itertools
...
# 产生ABCD和123的笛卡尔积
print(set(itertools.product('ABCD', '123')))
# 产生ABC的无限循环序列
...
print(counter.most_common(3)    )  # 返回出现频率最高的前三元素